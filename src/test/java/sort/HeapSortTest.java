...
public class HeapSortTest {
    ...
    @Test
    public void testSortWhenGivenNullArrayThenReturnNull() {
        int[] nums = null;
        int[] expected = null;
        int[] result = sorter.sort(nums);
        assertArrayEquals(expected, result, "The sorted array does not match the expected array");
    ...
    @Test
    public void testSortByHeapV3WhenGivenUnsortedArrayThenReturnSortedArray() {
        int[] nums = {5, 2, 8, 9, 1, 3};
        int[] expected = {1, 2, 3, 5, 8, 9};
        int[] result = sorter.sortByHeapV3(nums);
        assertArrayEquals(expected, result, "The sorted array does not match the expected array");
    }

    @Test
    public void testSortByHeapV3WhenGivenSortedArrayThenReturnSortedArray() {
        int[] nums = {1, 2, 3, 4, 5, 6};
        int[] expected = {1, 2, 3, 4, 5, 6};
        int[] result = sorter.sortByHeapV3(nums);
        assertArrayEquals(expected, result, "The sorted array does not match the expected array");
    ...
    @Test
    public void testSortByHeapV3WhenGivenDescendingArrayThenReturnSortedArray() {
        int[] nums = {6, 5, 4, 3, 2, 1};
        int[] expected = {1, 2, 3, 4, 5, 6};
        int[] result = sorter.sortByHeapV3(nums);
        assertArrayEquals(expected, result, "The sorted array does not match the expected array");
    ...
    @Test
    public void testSortByHeapV3WhenGivenUnsortedArrayWithPositiveAndNegativeIntegersThenReturnSortedArray() {
        int[] nums = {5, -2, 8, -9, 1, -3};
        int[] expected = {-9, -3, -2, 1, 5, 8};
        int[] result = sorter.sortByHeapV3(nums);
        assertArrayEquals(expected, result, "The sorted array does not match the expected array");
    ...
    @Test
    public void testSortByHeapV3WhenGivenEmptyArrayThenReturnEmptyArray() {
        int[] nums = {};
        int[] expected = {};
        int[] result = sorter.sortByHeapV3(nums);
        assertArrayEquals(expected, result, "The sorted array does not match the expected array");
    ...
    @Test
    public void testSortByHeapV3WhenGivenNullArrayThenReturnNull() {
        int[] nums = null;
        int[] expected = null;
        int[] result = sorter.sortByHeapV3(nums);
        assertArrayEquals(expected, result, "The sorted array does not match the expected array");
    ...
    @Test
    public void testSortByHeapV3WhenGivenArrayWithDuplicateElementsThenReturnSortedArray() {
        int[] nums = {5, 2, 2, 9, 1, 3, 3, 5};
        int[] expected = {1, 2, 2, 3, 3, 5, 5, 9};
        int[] result = sorter.sortByHeapV3(nums);
        assertArrayEquals(expected, result, "The sorted array does not match the expected array");
